...
import StartHeaader from "@/components/StartHeader";
...
const page = () => {
  ...
  const reasons: butt[] = [
    ...
    },
    {
      ...
      desc: "A personalized dashboard",
    },
  ];
  return (
    <section className="bg-[#fffdfa] ">
      <StartHeaader />
      <div className="container md:mx-auto md:px-32 ">
        <div className="md:pt-52 pt-44 flex justify-center">
          <h2 className="font-medium md:font-semibold text-2xl md:text-4xl text-center">
            Hi, I'm Betsy!
            <br />
        ...
        {buttons.map((v, i) => (
          <div className="flex flex-col justify-center mt-10 items-center">
            <button className="button1 flex items-center gap-5 w-[300px] md:w-[500px] ">
              {v.img}
              <span className="text-start">{v.desc}</span>
            </button>
          </div>
        ))}
        ...
        <div className="flex justify-center gap-10 mt-20 ">
          <div className="text-center">
            ...
            <p className="text-[10px]"> home loans funded entirely online</p>
          </div>
          <div className="text-center">
            <p className="text-2xl font-semibold">400K</p>
            <p className="text-[10px]">Customers who chose a Better Mortgage</p>
          </div>
        </div>

        <div className="mt-10  text-gray-500 flex justify-center ">
          <div className="bg-[#f0f7f1] md:px-32 px-20 rounded-xl py-5">
            <h2 className="mb-5 text-sm">
              After a few questions,you'll unlock:
            </h2>
            {reasons.map((v, i) => (
              <div className="flex mt-5 justify-start text-xs gap-1 items-center">
                {v.img}
                <p>{v.desc}</p>
              </div>
            ))}
