...
const StartHeaader = () => {
  return (
    <div className="fixed w-full bg-[#fffdfa]">
      <div className="mt-10 md:mx-32 mx-5">
        <div className="flex items-center justify-between gap-5 ">
          ...
          <div className="flex gap-3 text-sm font-medium items-center">
            ...
            <p className="md:block hidden">Need help? call (415) 523 8837</p>
          </div>
        </div>
        <div className="mt-5">
          <div className="h-1 rounded-xl bg-gray-100"></div>
          <div className="flex justify-center items-center">
            <div className="-mt-6 rounded-full overflow-hidden w-[45px] h-[45px]">
              <Image
                alt=""
                src="/betty1.png"
